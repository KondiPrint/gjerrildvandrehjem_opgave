        ...
        <div className='mx-auto w-fit'>
          ...
          <div className='flex md:gap-10 sm:gap-5 flex-wrap justify-center gap-2'>
            <figure className='flex flex-col justify-center'>
              <img src='../../../../assets/images/ikoner/bathICON.png' alt='' className='h-16 w-24 bg-reseda fill-offWhite p-1 px-4 rounded-md mx-auto' />
              <figcaption>
            ...
            <figure className='flex flex-col justify-center'>
              <img src='../../../../assets/images/ikoner/windowICON.png' alt='' className='h-16 w-24 bg-reseda fill-offWhite p-1 px-4 rounded-md mx-auto' />
              <figcaption>
            ...
            <figure className='flex flex-col justify-center'>
              <img src='../../../../assets/images/ikoner/deskchairICON.png' alt='' className='h-16 w-24 bg-reseda fill-offWhite p-1 px-4 rounded-md mx-auto' />
              <figcaption>
            ...
            <figure className='flex flex-col justify-center'>
              <img src='../../../../assets/images/ikoner/weekendsenglagenICON.png' alt='' className='h-16 w-24 bg-reseda fill-offWhite p-1 py-2 rounded-md mx-auto' />
              <figcaption>
