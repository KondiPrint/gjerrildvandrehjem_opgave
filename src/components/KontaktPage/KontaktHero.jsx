...
import FormSetupKontakt from './FormSetup';

export default function KontaktHero() {
  return (
    <>
      <div className='hero min-h-screen relative bg-reseda grid grid-cols-2'>
        <div className='absolute top-0 text-offWhite w-full'>
          <Header />
        </div>
        <div className='max-w-xl font-main_font pt-12'>
          ...
          <p className='italic text-offWhite font-main_font text-xl drop-shadow-2xl mb-10'>
            ...
            hurtigst muligt, du er også altid velkommen til at ringe på 40224199
          </p>
          ...
          <div className='w-1/2 my-5 border-b-2'>
            ...
            <a className='hover:brightness-75' href='tel:+4540224199'>
              +45 40224199
            </a>
          </div>
          <div className='w-1/2 my-5 border-b-2'>
            ...
            <a className='hover:brightness-75' href='mailto:info@gjerrildvandrerhjem.dk'>
        ...
        <div className='h-full w-full col-start-2 col-span-2 flex justify-end'>
