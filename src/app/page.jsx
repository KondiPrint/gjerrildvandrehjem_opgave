        ...
        <main className='min-h-full'>
          ...
          <section className='bg-section_colour p-4'>
            <div className='container text-center mx-auto font-main_font mb-10 text-offWhite lg:w-1/2'>
              ...
              <p>
                Her finder du en samlet oversigt over alle de spændende ting der sker på Gjerrild vandrerhjem. Hvis du har en idé til noget du gerne vil afholde hos os, så tøv ikke med at kontakte os,
                vi elsker gode initiativer og ideer. Vi ønsker at være både et vandrerhjem og kulturhus, og vi kan facilitere alt lige fra foredrag og koncerter, til kurser og festivaler.
              </p>
            </div>
